...
// v2.15 - Restoration of rich landing page details and feature tour
...
const GOOGLE_CLIENT_ID = "290114942318-u4s685k90oevmpe68b3p0g1b6m2u8b8r.apps.googleusercontent.com";
            ...
            callback: async (response: any) => {
              if (response.credential) {
                ...
                if (user) {
                  ...
                  setError("Error de sincronización. Por favor reintenta.");
      ...
      <section className="relative min-h-[90vh] flex flex-col items-center justify-center px-4 pt-20 pb-32">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center space-y-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-50 dark:bg-brand-900/20 border border-brand-100 dark:border-brand-800 animate-in fade-in slide-in-from-top-4 duration-1000">
             ...
             <span className="text-xs font-bold uppercase tracking-widest text-brand-700 dark:text-brand-400">Versión 2.15 Estable</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-6 pt-4">
            <div className="bg-white dark:bg-zinc-900 p-6 rounded-3xl border border-zinc-200 dark:border-zinc-800 shadow-2xl backdrop-blur-xl">
               {isAuthenticating ? (
            ...
            <div className="flex items-center gap-6 text-zinc-400 dark:text-zinc-600">
               <div className="flex items-center gap-1.5"><ShieldCheck size={16} /> <span className="text-[10px] font-bold uppercase tracking-wider">Cloud Secured</span></div>
